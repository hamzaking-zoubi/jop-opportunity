...
public class Fragment_courses extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        contactView = inflater.inflate(R.layout.fragment_courses, container, false);
        setHasOptionsMenu(true);
        database = FirebaseDatabase.getInstance();
        reference = database.getReference().child("Main");
        bar = contactView.findViewById(R.id.progressBar_courses);
        firebaseAuth = FirebaseAuth.getInstance();
        swipeRefreshLayout = (SwipeRefreshLayout) contactView.findViewById(R.id.swipeRefreshLayout_courses);

        recyclerView = contactView.findViewById(R.id.rv_courses);
        ...
        mJobs = new ArrayList<>();
        adapter = new MyAdapter(mJobs, getActivity().getBaseContext(), new OnRecyclerviewItemClickListener() {
            @Override
        ...
        if (eventListener == null) {
            ...
            eventListener = new ChildEventListener() {
                ...
                public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                    ...
                    if (s.getCategory() == "courses" || s.getCategory().equals("courses")) {
                        adapter.addJob(s);
                        recyclerView.setAdapter(adapter);
