...
public class Fragment_Militaryjobs extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        contactView = inflater.inflate(R.layout.fragment_militaryjobs, container, false);
        setHasOptionsMenu(true);
        database = FirebaseDatabase.getInstance();
        reference = database.getReference().child("Main");
        database = FirebaseDatabase.getInstance();
        firebaseAuth = FirebaseAuth.getInstance();
        swipeRefreshLayout = (SwipeRefreshLayout) contactView.findViewById(R.id.swipeRefreshLayout_military);

        recyclerView = (RecyclerView) contactView.findViewById(R.id.military_rv);
        ...
        bar = contactView.findViewById(R.id.progressBar_military);
        ...
        if (eventListener == null) {
            ...
            eventListener = new ChildEventListener() {
                ...
                public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                    ...
                    if (s.getCategory() == "military" || s.getCategory().equals("military")) {
                        adapter.addJob(s);
                        recyclerView.setAdapter(adapter);
